...
- **Analítica y consentimiento**: Google Tag Manager + GA4 y **Microsoft Clarity**, con **Consent Mode v2** y banner de consentimiento granular (RGPD), con página propia de privacidad y cookies. Todo gateado a producción **y** a consentimiento: nada mide sin él. **Con una excepción escrita, que es la que da el denominador** (`D169`): tres enteros —visto, aceptado, rechazado— que dicen qué fracción del tráfico ve la analítica. No es dato personal, así que no pasa por la puerta del consentimiento, y `/cookies` lo declara.
