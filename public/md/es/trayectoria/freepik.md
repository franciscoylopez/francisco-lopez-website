...
Freepik · SaaS B2C · UGC

# Gran empresa, mal momento
...
## 02. Tres meses que empiezan un año antes

### Ordenar la cabeza antes del siguiente reto

Salí de TheTool después de cinco años: mi primer proyecto de producto, empezado desde cero y recorrido entero hasta la venta. Quería un reto nuevo, pero antes quería ordenar la cabeza: había aprendido media década por necesidad y sobre la marcha, sin contrastar casi nada.

Así que me formé de forma reglada, y en ese orden. Primero agilidad: un máster en Scrum con theUncoding, con las certificaciones de Product Owner y Scrum Master, porque era el marco dentro del que iba a trabajar en cualquier sitio. Después producto, con el programa de Product Management de TheHeroCamp. Lo que me llevé no fue tanto lo nuevo como el nombre y el porqué de cosas que ya había hecho en TheTool. Antes de terminar el curso apareció Freepik.

### Por qué Freepik y por qué contributors
...
La herramienta de analítica de producto se estaba eligiendo en ese momento, así que la evidencia había que buscarla en otra parte. Reconstruí el discovery del trimestre anterior (encuestas, entrevistas y datos internos), que era la base con la que iba a definir y gestionar los OKR del primer trimestre, y me sumé a la encuesta de fin de año que Freepik lanzaba a sus contributors.
...
## 03. Tres cosas que me llevo de tres meses

1. **El volumen cambia el método, no solo la muestra.** Cientos de respuestas largas en pocos días son una ventaja que casi ningún proyecto tiene, pero piden otra forma de analizar: con quince entrevistas lees; con cuatrocientas respuestas, categorizas antes de leer.
2. **Un sistema de OKR bien hecho se reconoce en cuanto lo ves.** Fue el primer sitio donde los encontré tomados en serio y bien estructurados, y la diferencia con un sistema de objetivos de adorno es que estos se usan para decir que no.
3. **En ocasiones no se elige una empresa, se elige un squad.** Freepik era una gran empresa y aun así no era mi sitio. En qué área entras, qué objetivos tiene y cuánta continuidad se le ve pesan más que el nombre, y son justo lo que no se mira cuando el nombre impresiona.

Seguir leyendo

[Experiencia anterior · TheTool · Cofounder & Product · May 2016 - Oct 2021](https://franciscolopez.es/trayectoria/thetool) · [Experiencia siguiente · INDYA · Product Lead · Ene 2022 - Dic 2023](https://franciscolopez.es/trayectoria/indya)
