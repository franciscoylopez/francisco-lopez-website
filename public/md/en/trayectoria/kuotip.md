...
# The missed chance to change an industry
...
## 02. Three pieces to fix a broken industry
...
Identity verification + content that helps + a current format. With those three pieces we had the base to change a broken industry where brands invest large budgets, so we hired a product designer and an external development team led by our CTO, set up two-week sprints with clear milestones, and went out to raise.
...
## 03. Three things I take from a project that never launched

1. **Execution and timing beat ideas.** The project made complete sense (in fact, things we conceptualised can be seen today at companies the size of Amazon) but we were not able to execute it at the moment it needed executing.
2. **If your project needs outside funding to exist, you had better have someone on the team who knows that world.** There were three of us with strong digital backgrounds, each in our own area, and none of us knew investment. That is probably where the points we were missing went.
3. **Do not start a project if you do not have the team or the resources to get the first 25 customers.** With the data from those 25, funding would have been easier, or not even necessary.
