...
## 02. Three months that start a year earlier

### Getting my head in order before the next challenge

I left TheTool after five years: my first product project, started from scratch and followed all the way to the sale. I wanted a new challenge, but first I wanted to get my head in order: I had spent half a decade learning out of necessity and on the fly, with almost nothing contrasted.

So I trained formally, and in that order. Agility first: a master's degree in Scrum with theUncoding, with the Product Owner and Scrum Master certifications, because that was the framework I would be working inside anywhere. Product second, with TheHeroCamp's Product Management programme. What I took away was not so much the new as the name and the why of things I had already done at TheTool. Freepik came up before the course was over.

### Why Freepik and why contributors
...
The product analytics tool was being chosen right then, so the evidence had to be found elsewhere. I rebuilt the previous quarter's discovery (surveys, interviews and internal data), which was the base I would use to define and manage the first quarter's OKRs, and I joined the year-end survey Freepik ran with its contributors.
...
## 03. Three things I take from three months

1. **Volume changes the method, not just the sample.** Hundreds of long responses in a few days are an advantage almost no project has, but they demand a different way of analysing: with fifteen interviews you read; with four hundred responses, you categorise before reading.
2. **A well-built OKR system is recognisable on sight.** It was the first place where I found them taken seriously and properly structured, and the difference from a decorative goal system is that these are used to say no.
3. **Sometimes you don't pick a company, you pick a squad.** Freepik was a great company and it still was not my place. Which area you join, what goals it has and how much continuity it is given weigh more than the name, and they are exactly what nobody checks when the name is impressive.
