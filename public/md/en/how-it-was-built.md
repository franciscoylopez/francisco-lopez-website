---
canonical: https://franciscolopez.es/en/how-it-was-built
lang: en
...
Every section closes on its own: you can read it in chunks, in any order. The bar along the top edge tracks where you are. **9752** words· · **12** sections
...
8. [08 · Security, SEO and hosting · ≈9 min](#s08)
...
[PRD-Live.md](https://github.com/franciscoylopez/francisco-lopez-website/blob/main/PRD-Live.md), sections 1 through 3 and 9, and decision [D29](https://github.com/franciscoylopez/francisco-lopez-website/blob/main/DECISIONS.md?plain=1#L1219) for the contact strip
...
Decisions [D2](https://github.com/franciscoylopez/francisco-lopez-website/blob/main/DECISIONS.md?plain=1#L281), [D3](https://github.com/franciscoylopez/francisco-lopez-website/blob/main/DECISIONS.md?plain=1#L293), [D6](https://github.com/franciscoylopez/francisco-lopez-website/blob/main/DECISIONS.md?plain=1#L342), [D7](https://github.com/franciscoylopez/francisco-lopez-website/blob/main/DECISIONS.md?plain=1#L422) and [D51](https://github.com/franciscoylopez/francisco-lopez-website/blob/main/DECISIONS.md?plain=1#L2592) in the technical record
...
Decisions [D36](https://github.com/franciscoylopez/francisco-lopez-website/blob/main/DECISIONS.md?plain=1#L1482), [D40](https://github.com/franciscoylopez/francisco-lopez-website/blob/main/DECISIONS.md?plain=1#L1895), [D45](https://github.com/franciscoylopez/francisco-lopez-website/blob/main/DECISIONS.md?plain=1#L2259), [D46](https://github.com/franciscoylopez/francisco-lopez-website/blob/main/DECISIONS.md?plain=1#L2314) and [D72](https://github.com/franciscoylopez/francisco-lopez-website/blob/main/DECISIONS.md?plain=1#L4541), and the [components/ui/](https://github.com/franciscoylopez/francisco-lopez-website/blob/main/components/ui) directory
...
Everything above gets noticed because it produces something you look at. The ones that have saved me the most are nowhere to be seen. Three of them fire on their own **while I write**, the moment a file is touched: one formats it, another launches the colour guardian when that particular edit could have broken the invariant, and the third speaks up when the document I have just touched is the source a paragraph of this very page hangs from. A fourth waits until the very end: it will not let a branch be pushed with one of those seals in the red, because warning without blocking left the rate of red integrations exactly where it was. None of them adds anything to the site; they exist because the work they do used to depend on my remembering, and remembering isn't a mechanism.
...
Decision [D1](https://github.com/franciscoylopez/francisco-lopez-website/blob/main/DECISIONS.md?plain=1#L252), with its supersession note and the original decision kept below it

7 of 12

[Contents](#indice) · [Next: 08 · Security, SEO and hosting](#s08)

8 of 12 · 9 min

08 — Security, SEO and hosting

## 08. What you don't see: the technical side, and the debt that didn't pile up
...
### Ready for SEO and GEO

The technical SEO is done page by page. Each of the fourteen pages carries its own title and description, its **canonical URL**, its **three language tags** so the Spanish and the English version don't compete with each other, its **Open Graph card** for when someone shares the link, and its **Schema.org structured data** block with the type it should have: a person entity on the home page, a technical article on this one, a contact page on Contacto, and a breadcrumb trail on every inner page. The sitemap and robots.txt list them all, in both languages.
...
Agents · ora.ai · `npm run agentes:sellar · 31 August 2026`

78 out of 100

[See the report](https://ora.ai/score/franciscolopez.es)

Grade B · 125 checks · 60 not applicable
...
