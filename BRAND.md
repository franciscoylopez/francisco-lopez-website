...
- Todo texto y todo elemento interactivo debe cumplir WCAG AA (4.5:1 texto, 3:1 UI). **AA es el suelo, no el objetivo:** se empuja a AAA siempre que se pueda. Estado a **2026-08-09**, medido en navegador sobre los tokens tal como renderizan, claro / oscuro: texto principal 13,79 / 15,32; `primary` como texto 7,47 / 8,36; texto sobre botón 7,93 / 8,36; hover del sólido 8,64 / 8,92; hover del `toggle-primary` apagado 7,21 / 7,80; `muted-foreground` 7,10 / 7,12; bolita del switch 12,47 / 12,04 apagada y 7,93 / 8,36 encendida; **etiqueta neutra 8,17 / 9,17 y etiqueta teñida 10,63 / 10,02** (P37.655); **hover del chrome secundario 12,47 / 12,04** (P37.656). **Todos los pares del sistema están en AAA en ambos temas, en reposo y en hover. Sin excepciones.**
