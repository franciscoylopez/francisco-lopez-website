...
- **Si algún día hay más de dos iconos propios**, publicarlos en el Brand Kit — el recorrido completo (regla → uso → página publicada) es lo que hace que una regla deje de depender de que alguien se acuerde.
