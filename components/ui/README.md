...
### artículo · 2
- **`article-islands.tsx`** — Las islas de cliente del texto largo: riel de secciones, copiar enlace, compartir. *([design-system/12-articulo](../site/design-system/12-articulo.tsx))*
- **`article.tsx`** — Los bloques del texto largo: portada de capítulo, cita, diagrama, cierre. *([design-system/12-articulo](../site/design-system/12-articulo.tsx))*
