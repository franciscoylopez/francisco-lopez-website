...
- **`section-index.tsx`** — La navegación de una página con paradas: el índice y el cierre de bloque. *([design-system/12-articulo](../site/design-system/12-articulo.tsx))*
