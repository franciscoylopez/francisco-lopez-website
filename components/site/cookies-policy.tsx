...
// Google Tag Manager, que desde P74.55 solo carga con consentimiento (D214), y con él
// las cookies de Google Analytics + Microsoft Clarity (P37).
//
        ...
        <div className={WRAP}>
          ...
          <div className="mt-[clamp(2.5rem,5vw,3.5rem)] flex flex-col gap-[clamp(2rem,4vw,3rem)]">
            ...
            <Section heading={t.counterHeading}>
              {/* Con `Rich` y no texto plano: los párrafos llevan enlaces a las
                  políticas de los proveedores y a la sección de contacto de esta
                  misma página, que es la vía de oposición que el tercero ofrece.
                  Un enlace ahí no es adorno: es el mecanismo.

                  FUERON CUATRO ENTRE D211 Y D214: el ping sin cookies de GA4
                  estuvo declarado aquí hasta que el gate de GTM pasó a depender
                  del consentimiento. Vuelven a ser tres, y la parte incómoda
                  cubre solo a Vercel Web Analytics (D170). */}
              <p>
