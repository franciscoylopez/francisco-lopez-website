...
| Accesibilidad | AA de suelo, AAA objetivo | **Cero pares bajo AAA** y **cero contornos bajo el 3:1 de WCAG 1.4.11** en las catorce páginas × 2 temas, en reposo y en hover — 368 pares de texto y 276 contornos de control, `npm run censo` (D85/D97); **0 violaciones de axe** |
