...
/**
 * EL SEGUNDO PASE, a nivel superior (P50.84, 2026-08-28). Estaba anidado dentro
 * de `contrastCensus`, que llegó así a 164 de complejidad y 30 retornos. Anidarlo
 * un nivel más NO habría servido —qlty suma las anidadas al padre—; lo que parte
 * el conteo de una FUNCIÓN es que deje de estar dentro.
 *
 * Devuelve el mapa de controles indexados; quien lo llama decide qué hacer con él.
 */
function censarContornos() {
  ...
  // Las dos cifras de cobertura salen con el mapa: son lo que impide que un cero
  // se lea como un aprobado, y viven donde se cuentan.
