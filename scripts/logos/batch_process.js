...
const jobs = [
  ...
  {
    src: `${SRC}/Tools/Claude desing.webp`,
    out: "tools",
    name: "claude-design",
  },
  ...
  {
    src: `${SRC}/Tools/Google Analytics.webp`,
    out: "tools",
  ...
  {
    src: `${SRC}/Tools/Microsoft-Clarity.webp`,
    out: "tools",
  ...
  {
    src: `${SRC}/Formacion/OleaEuropea.webp`,
    out: "education",
    name: "olea-europea",
  },
  {
    src: `${SRC}/Formacion/TheHeroCamp.webp`,
    out: "education",
    name: "the-hero-camp",
  },
  {
    src: `${SRC}/Formacion/theUncoding.webp`,
    out: "education",
    name: "the-uncoding",
  },
];
...
(async () => {
  ...
  console.log("---");
  console.log(
    failures.length ? `Failures: ${failures.join(", ")}` : "All processed OK",
  );
})();
